...
export const ROLES: RoleConfig[] = [
  ...
  {
    key: "pro-user",
    label: "Become Pro User",
    tagline: "Unlock more software for your business",
    blurb: "For businesses, professionals and teams that need the full catalog.",
    accent: "from-indigo-400 to-blue-600",
    fee: "Free",
    feeNote: "No application fee — plan is selected after approval.",
    workflow: ["Application received", "Business verification", "Plan selection", "Pro workspace access"],
    agreement: "Pro User Terms — per-seat usage, fair-use limits and standard support SLA.",
    dashboard: "Pro Dashboard — licences, team seats, invoices, support.",
    sections: [
      personal,
      company(false),
      {
        ...
        fields: [
          { name: "softwareNeeded", label: "Software / Categories Needed", type: "textarea", required: true, placeholder: "CRM, HRM, Accounting…" },
          { name: "userSeats", label: "Number of Users", type: "number", required: true, half: true },
          { name: "deployment", label: "Preferred Deployment", type: "select", options: ["Cloud (SaaS)", "Self hosted", "Hybrid"], half: true },
          { name: "timeline", label: "Expected Start Timeline", type: "text", half: true },
        ],
      },
      identity,
    ],
  ...
  {
    key: "seo-expert",
    label: "Become SEO Partner",
    tagline: "Grow software brands and expand your client base",
    blurb: "For SEO specialists, agencies and growth experts.",
    accent: "from-lime-300 to-emerald-600",
    fee: "Free",
    feeNote: "No application fee — engagement based.",
    workflow: ["Application received", "Portfolio & case study review", "Capability call", "Partner agreement", "SEO partner panel access"],
    agreement: "SEO Partner Agreement — scope per engagement, white-hat practices only and reporting standards.",
    dashboard: "SEO Partner Dashboard — projects, keywords, reports, invoices.",
    sections: [
      personal,
      company(false),
      {
        ...
        fields: [
          { name: "seoExperience", label: "SEO Experience (years)", type: "number", required: true, half: true },
          { name: "specialisation", label: "Specialisation", type: "select", options: ["Technical SEO", "Content SEO", "Local SEO", "International SEO", "Full stack SEO"], required: true, half: true },
          { name: "toolsUsed", label: "Tools Used", type: "text", half: true, placeholder: "Ahrefs, SEMrush, GSC…" },
          { name: "teamCapacity", label: "Monthly Project Capacity", type: "number", half: true },
          { name: "caseStudies", label: "Case Studies / Results", type: "textarea", required: true },
          { name: "portfolio", label: "Portfolio / Website", type: "url", placeholder: "https://", half: true },
        ],
      },
      identity,
    ],
  },
  {
    ...
    label: "Become Technology Partner",
    tagline: "Build solutions and grow with our ecosystem",
    blurb: "For developers, agencies and technology companies.",
    accent: "from-teal-300 to-sky-600",
    fee: "Free",
    feeNote: "No application fee — partnership tiers assigned after review.",
    workflow: ["Application received", "Technical capability review", "Integration scoping", "Partner agreement", "Partner portal access"],
    agreement: "Technology Partner Agreement — integration standards, security requirements and joint go-to-market terms.",
    dashboard: "Technology Partner Portal — integrations, sandbox keys, roadmap, support.",
    sections: [
      personal,
      company(true),
      {
        ...
        fields: [
          { name: "techStack", label: "Primary Technology Stack", type: "text", required: true, half: true },
          { name: "partnershipType", label: "Partnership Type", type: "select", options: ["Integration Partner", "Implementation Partner", "OEM / White Label", "Infrastructure Partner"], required: true, half: true },
          { name: "engineeringTeam", label: "Engineering Team Size", type: "number", half: true },
          { name: "existingProducts", label: "Existing Products / Platforms", type: "textarea", required: true },
          { name: "repository", label: "GitHub / Portfolio", type: "url", placeholder: "https://", half: true },
        ],
      },
      identity,
      bank,
